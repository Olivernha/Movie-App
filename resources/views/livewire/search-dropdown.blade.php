<div class="relative mt-3 md:mt-3" x-data="{ isOpen: true }" @click.away="isOpen = false">
    <input
        ...
        type="text"
        class="bg-blue-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search (Press '/' to focus)"
        x-ref="search"
        @keydown.window="
    ...
    @if(strlen($search) > 2)
        <div class="absolute bg-gray-800 text-sm rounded w-64 mt-4 z-20" x-show.transition.opacity="isOpen" >

    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    <h4 class="text-white font-semi-bold">Featured Cast</h4>
                    <div class="flex mt-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="{{route('actors.show',$cast['id'])}}">
                        <img src="{{'https://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" alt="actor" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                    <div class="mt-2">

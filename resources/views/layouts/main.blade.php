...
<nav class="container flex mx-auto items-center justify-between flex-wrap bg-blue-900 p-6">
    ...
    <div class="block lg:hidden">
        <button onclick="navToggle();" id="menuBtn" class="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
            <svg class="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
        </button>
    </div>
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto" id="menu">
        <div class="text-sm lg:flex-grow">
            <a href="{{route('movies.index')}}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                Movie
            </a>
            <a href="{{route('tv.index') }}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                Tv Shows
            </a>
            <a href="{{ route('actors.index') }}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                Actors
            </a>
        </div>
        <div class="flex flex-col md:flex-row items-center">
                                <livewire:search-dropdown />
                                <div class="md:ml-4 mt-1 md:mt-2">
                                    <a href="#" >
                                        <img src="/images/Suzy.jpg" alt="avatar" class="rounded-full w-8 h-8">
                                    </a>
                                </div>
                            </div>
    </div>
